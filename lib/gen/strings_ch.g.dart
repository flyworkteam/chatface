...
class _TranslationsVideoViewCh implements TranslationsVideoViewEn {
	...
	@override String get saveFilter => '保存滤镜';
}
...
class _TranslationsVideoViewFiltersCh implements TranslationsVideoViewFiltersEn {
	...
	@override String get ADEN => '阿登';
	@override String get AMARO => '阿马罗';
	@override String get ASHBY => '阿什比';
	@override String get BRANNAN => '布兰南';
	@override String get BROOKLYN => '布鲁克林';
	@override String get CLARENDON => '克拉伦登';
	@override String get CREMA => '克里马';
	@override String get DOGPATCH => '狗补丁';
	@override String get GINGHAM => '格纹';
	@override String get GINZA => '银座';
	@override String get HEFE => '赫夫';
	@override String get HUDSON => '哈德逊';
	@override String get INKWELL => '墨水泉';
	@override String get JUNO => '朱诺';
	@override String get LARK => '百灵鸟';
	@override String get LOFI => '低保真';
	@override String get LUDWIG => '路德维希';
	@override String get MOON => '月亮';
	@override String get PERPETUA => '永恒';
	@override String get REYES => '雷耶斯';
	@override String get SIERRA => '塞拉';
	@override String get SLUMBER => '睡眠';
	@override String get STINSON => '斯廷森';
	@override String get SUTRO => '苏特罗';
	@override String get WALDEN => '瓦尔登';
	@override String get WILLOW => '柳树';
...
extension on TranslationsCh {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'videoView.filters.ADEN' => '阿登',
			'videoView.filters.AMARO' => '阿马罗',
			'videoView.filters.ASHBY' => '阿什比',
			'videoView.filters.BRANNAN' => '布兰南',
			'videoView.filters.BROOKLYN' => '布鲁克林',
			'videoView.filters.CLARENDON' => '克拉伦登',
			'videoView.filters.CREMA' => '克里马',
			'videoView.filters.DOGPATCH' => '狗补丁',
			'videoView.filters.GINGHAM' => '格纹',
			'videoView.filters.GINZA' => '银座',
			'videoView.filters.HEFE' => '赫夫',
			'videoView.filters.HUDSON' => '哈德逊',
			'videoView.filters.INKWELL' => '墨水泉',
			'videoView.filters.JUNO' => '朱诺',
			'videoView.filters.LARK' => '百灵鸟',
			'videoView.filters.LOFI' => '低保真',
			'videoView.filters.LUDWIG' => '路德维希',
			'videoView.filters.MOON' => '月亮',
			'videoView.filters.PERPETUA' => '永恒',
			'videoView.filters.REYES' => '雷耶斯',
			'videoView.filters.SIERRA' => '塞拉',
			'videoView.filters.SLUMBER' => '睡眠',
			'videoView.filters.STINSON' => '斯廷森',
			'videoView.filters.SUTRO' => '苏特罗',
			'videoView.filters.WALDEN' => '瓦尔登',
			'videoView.filters.WILLOW' => '柳树',
			'videoView.filters.XPROII' => 'XProII',
			'videoView.saveFilter' => '保存滤镜',
			_ => null,
		};
	}
}
